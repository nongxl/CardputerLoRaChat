...
inline void draw_log_icon(M5Canvas *canvas, int x, int y)
{
  canvas->pushImage(x - logWidth / 2, y - logHeight / 2, logWidth, logHeight, (uint16_t *)logData, transparencyColor);
}